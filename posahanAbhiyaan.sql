...
-- truncate table childvaccinations;
...
select * from pregnantTests;

delete from user where userName="Rishika";

select * from user;

select * from child;

select * from pregnantPerson where userid=6;
...
select * from pregnantPerson;
-- drop table pregnantPerson;
delete from hospital where hName="Femina Womens";

UPDATE pregnantPerson SET day261Status = 'false' WHERE ppid='1';
select * from pregnantPerson where userid=7 and day261Status is null;
